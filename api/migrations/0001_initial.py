# Generated by Django 6.0.1 on 2026-01-09 09:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='option', to='api.question')),
            ],
        ),
        migrations.CreateModel(
            name='Quiz',
